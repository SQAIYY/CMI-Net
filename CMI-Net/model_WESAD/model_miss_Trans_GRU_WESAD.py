...
if __name__ == '__main__':
    ...
    x1 = torch.randn((2, 10, 1, 3000)).to(device)
    x2 = torch.randn((2, 10, 1, 3000)).to(device)
    ...
    y_miss_hr = y_miss_hr.repeat(4).to(device)
    y_miss_xyz = y_miss_xyz.repeat(4).to(device)

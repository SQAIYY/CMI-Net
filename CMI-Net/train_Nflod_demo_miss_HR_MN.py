...
import model_HR_MN.model_miss_Trans_GRU as module_arch  # model_EEG_CNNvit_Orthogv2
from parse_config import ConfigParser
from trainer.trainer_old_miss2 import Trainer
...
def main(config, fold_id):
    ...
    data_loader, valid_data_loader, data_count, train_data_count = data_generator_np_miss(folds_data[fold_id][0],
...
if __name__ == '__main__':
    ...
    if "shhs" in args2.np_data_dir:
        ...
        folds_data = load_folds_data_wearable(args2.np_data_dir, config["data_loader"]["args"]["num_folds"])

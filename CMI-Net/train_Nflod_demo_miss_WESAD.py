...
#import model_WESAD.model_miss_Trans_GRU_WESAD as module_arch  # model_EEG_CNNvit_Orthogv2
import model_WESAD.model_miss_Trans_GRU_WESAD as module_arch  # model_EEG_CNNvit_Orthogv2
from parse_config import ConfigParser
from trainer.trainer_old_miss_WESAD import Trainer
...
def main(config, fold_id):
    ...
    criterion_Miss_MSE_ECG = MSE_KLD_Loss()
    criterion_Miss_MSE_EDA = MSE_KLD_Loss()
    ...
    trainer = Trainer(model, criterion,  metrics,
                      ...
                      class_weights=weights_for_each_class)
    """
    trainer = Trainer(model, criterion, criterion_Miss_SC, criterion_Miss_MSE_ECG, criterion_Miss_MSE_EDA, metrics,
                      optimizer,
                      config=config,
                      data_loader=data_loader,
                      fold_id=fold_id,
